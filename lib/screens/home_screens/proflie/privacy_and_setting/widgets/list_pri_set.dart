...
class ListPriSet extends StatelessWidget {
  const ListPriSet({super.key, required this.iconLea, required this.text, this.size, this.weightText, required this.iconTra});
...
final IconData iconTra;
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: TextApp(text: text,size: size,weightText: weightText,),
